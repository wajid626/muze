...
class TrainDataset(Dataset):
    def __init__(self):
        self.x = torch.from_numpy(np.load('/Users/wajidabdul/courses/cis579/code/muze/torch/process_data/Training_Data/train_x.npy').astype(np.float32))
        self.y = torch.from_numpy(np.load('/Users/wajidabdul/courses/cis579/code/muze/torch/process_data/Training_Data/train_y.npy').reshape(-1,1).astype(np.float32))
...
torch.save(best_model.state_dict(), '/Users/wajidabdul/courses/cis579/code/muze/torch/model.pt')

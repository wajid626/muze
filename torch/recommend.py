...
class RecommendModel:
    ...
    def __call__(self, *args, **kwargs):
        ...
        # Load model
        model_val.load_state_dict(torch.load('/Users/wajidabdul/courses/cis579/code/muze/torch/model.pt', map_location='cpu'))
        model_val.eval()
...
@RecommendModel
def load_data():
    filenames = [ "/Users/wajidabdul/courses/cis579/code/muze/torch/process_data/Music_Sliced_Images/" + f for f in os.listdir("/Users/wajidabdul/courses/cis579/code/muze/torch/process_data/Music_Sliced_Images")
                    if f.endswith(".jpg")]
    images = []
    labels = []
    for f in filenames:
        song_variable = re.search(r'/Users/wajidabdul/courses/cis579/code/muze/torch/process_data/Music_Sliced_Images/.*_(.+?).jpg', f).group(1)
...
def recommend_songs(song_name, images, labels, new_model):
    ...
    with torch.no_grad():
        ...
        list_song = []
        choose_song = {'id': 1, 'name': recommend_wrt, 'link': '/Users/wajidabdul/courses/cis579/code/muze/torch/templates/music/'+ recommend_wrt + '.mp3', 'genre': 'Original Song'}
        ...
        while recommendations < 4:
            ...
            list_song.append({'id': recommendations, 'name': predictions_label[index], 'link': '/Users/wajidabdul/courses/cis579/code/muze/torch/templates/music/'+ predictions_label[index] + '.mp3', 'genre': 'Recommend Song', 'metrics': 'Similar:', 'value': value})
